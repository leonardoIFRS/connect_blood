...
programa {
  ...
  // chamada quando na abertura do programa e quando veltamos para o menu principal
  funcao menuLogin() {
    letreiroPrograma()  // Estou chamando a função ali de cima. o jeito de chamar uma função e escrever o nome dela com abre-fecha parênteses
    escreva("\n          ###### OPÇÕES DE LOGIN ######\n")
    escreva("          ####  1 - DOADOR         ####\n")
  ...
  funcao alerta(){
    ...
    escreva("        ####  DE REPOMSABILIZAÇÃO NOS TERMOS DA LEGISLAÇÃO VIGENTE.    ###")
    escreva("\n      ####################################################################\n")
  }
  ...
  funcao menuAgendamento() {
    ...
    escreva("        ####  3- Esteja bem alimentado(a) e use roupas confortávies  ###\n")
